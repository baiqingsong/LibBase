...
public abstract class LBaseDialog {
    ...
    protected void setDialogFullScreen(){
        if(view != null && mContext != null){
            FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(mContext.getResources().getDisplayMetrics().widthPixels, mContext.getResources().getDisplayMetrics().heightPixels);
